...
# 7.提取每行中完整的年月日和时间字段
s="""se234 1987-02-10 07:25:00 1987-02-09 07:30:00
"""
# pattern = re.compile(r'[1-2]\d{3}-(0[0-9]|1[0-2])-(0[1-9]|(1|2)[0-9]|3[0-1])\s(0[0-9]|1[0-9]|2[0-4]):([0-5][0-9]):([0-5][0-9])')
